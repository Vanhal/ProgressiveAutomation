...
import com.vanhal.progressiveautomation.client.gui.container.ContainerPlanter;
...
public class GUIPlanter extends BaseGUI {
    ...
    public static final ResourceLocation texture = new ResourceLocation(References.MODID, "textures/gui/planter.png");
