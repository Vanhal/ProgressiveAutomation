...
public class ItemCoalPellet extends BaseItem implements IFuelHandler  {
    ...
    protected void addNormalRecipe() {
    	ShapelessOreRecipe recipe = new ShapelessOreRecipe(new ItemStack(this, 9), Items.coal);
		GameRegistry.addRecipe(recipe);
		recipe = new ShapelessOreRecipe(new ItemStack(this, 9), new ItemStack(Items.coal, 1, 1));
		GameRegistry.addRecipe(recipe);
